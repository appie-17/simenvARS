...
def evolutionaryAlgorithm(num_iter, population_size, ndim, rn_range, benchmark_function, offspring, selection_method,
                          graphics=False):
    # Initialise
...
# Needed to make multiprocessing work in Windows:
if __name__ == "__main__":
    ...
    sim = Simulation(iter_sim, env_range, pos, robot_rad, sens_range, dT, Fitness)

    output = evolutionaryAlgorithm(iter_ea, population_size, ndim, rn_range, sim.simulate, offspring,
                                   selectionreproduction.TruncatedRankBased(offspring).apply)
    print(output)
