...
def evolutionaryAlgorithm(num_iter, population_size, ndim, rn_range, benchmark_function, offspring):
    ...
    fitness = benchmark_function(iter_sim,env_range, pos, robot_rad, sens_range, dT, weights=average_genotype, graphics=False)
    ...
    for _ in range(num_iter):
        ...
        for i in range(population_size):
            sim_start = time()
            fitness = benchmark_function(iter_sim,env_range, pos, robot_rad, sens_range, dT, weights=population[i], graphics=False)
